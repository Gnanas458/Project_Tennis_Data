...
# ✅ MySQL Configuration
MYSQL_USER = "root"
MYSQL_PASSWORD = "240996"
MYSQL_HOST = "localhost"
MYSQL_DB = "Tennis_project"
...
def get_competitors():
    query = """
        SELECT 
            ...
            r.player_rank AS `rank`, r.movement, r.points, r.competitions_played
        FROM competitors AS c
        JOIN rankings AS r ON c.competitor_id = r.competitor_id;
    """
